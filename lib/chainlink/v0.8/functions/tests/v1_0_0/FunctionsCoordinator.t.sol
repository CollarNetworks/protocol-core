...
contract FunctionsBilling_EstimateCost is FunctionsSubscriptionSetup {
    ...
    function test_EstimateCost_Success() public {
        ...
        uint96 costEstimate = s_functionsCoordinator.estimateCost(s_subscriptionId, requestData, callbackGasLimit, gasPriceWei);
        uint96 expectedCostEstimate = 10_873_200;
